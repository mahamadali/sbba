                 ...
                 <li class="mt-3 ml-1">
                  ...
                  <li class="mt-3 ml-1">
                    ...
                    <ul>
                       ...
                       <li>To enforce this Privacy Policy or our <a href="{{route('page', ['terms-conditions'])}}" style="color:blue">Terms of Service</a>;</li>
                    ...
                    <li class="mt-3 ml-1 ml-1">
                        ...
                        <p class="mt-2 ml-1">
                        Finally, to the extent the SBBA Web Platform allows you (or allows you in the future) to create log-in credentials, you are responsible for maintaining the secrecy of your user credentials, including your user identification, password, and/or other Personal Information that you use in connection with the SBBA Web Platform and/or Services. Always be careful and responsible regarding your account information and Personal Information. You are not authorized to share your account information with others (see our <a href="{{route('page', ['terms-conditions'])}}" style="color:blue">Terms of Service</a> for more details). 
                        </p>  
                        <p class="mt-2 ml-1">
