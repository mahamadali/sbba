    ...
    <div class="container aos-init aos-animate" data-aos="fade-up">
      ...
      <div class="row justify-content-center terms-of-use-info">
        <div class="terms-of-use-container">
            <span class="author-info">- Updated September 1 , 2022</span>
            <p class="mt-3">
              ...
              These Terms of Service set forth important information regarding your rights and obligations, as well as conditions, limitations, and exclusions that apply to you. <strong>If you do not agree to all of these Terms of Service, as well as the SBBA <a href="{{route('page', ['privacy-policy'])}}" style="color:blue;">Privacy Policy</a> (the “Privacy Policy”) that is incorporated herein by reference, you may not use the SBBA Web Platform.</strong>
              <br><br>
              ...
              <br><br>
              AGAIN, IF YOU CHOOSE TO ACCESS OR USE THE SBBA WEB PLATFORM, BY DOING SO YOU ARE AGREEING TO ACCEPT AND BE BOUND BY: (A) THESE TERMS OF SERVICE AND (B) THE <a href="{{route('page', ['privacy-policy'])}}" style="color:blue;">PRIVACY POLICY</a> AND COMMUNITY GUIDELINES. YOU FURTHER AGREE AND SUBMIT THAT (A) YOU WILL ACCESS AND USE THE SBBA WEB PLATFORM ONLY IN ACCORDANCE WITH THESE TERMS OF SERVICE AND ALL APPLICABLE LAWS, RULES, AND REGULATIONS AND (B) YOU ARE OVER 13 YEARS OLD AND COMPETENT TO ENTER INTO A BINDING CONTRACT IN YOUR JURISDICTION.
              <br><br>
              ...
              <ol class="terms-of-use">
                ...
                <li>
                  <u>Account Registration & Associated Information</u>. When you register to access or become a member of the SBBA Web Platform, and / or at other times while using the SBBA Web Platform, you may be asked to provide certain personal information to us (“User Data”). The <a href="{{route('page', ['privacy-policy'])}}" style="color:blue;">Privacy Policy</a> (link above) sets forth our policies relating to the collection, use, and privacy of such User Data and the <a href="{{route('page', ['privacy-policy'])}}" style="color:blue;">Privacy Policy</a> is incorporated herein by reference. We encourage you to review the <a href="{{route('page', ['privacy-policy'])}}" style="color:blue;">Privacy Policy</a> in detail, and you must accept and agree to its terms (including through your agreement to these Terms of Service) as a condition of accessing the SBBA Web Platform. You acknowledge and agree that you are solely responsible for the accuracy and content of User Data, and that it is your responsibility to keep it up to date and accurate.
                  <br><br>
