      ...
      <div class="row justify-content-center terms-of-use-info">
        <div class="terms-of-use-container">
            ...
            <p class="mt-3">
              ...
              These Terms of Service set forth important information regarding your rights and obligations, as well as conditions, limitations, and exclusions that apply to you. <strong>If you do not agree to all of these Terms of Service, as well as the SBBA <a href="{{route('privacy-policy')}}" style="color:blue;">Privacy Policy</a> (the “Privacy Policy”) that is incorporated herein by reference, you may not use the SBBA Web Platform.</strong>
              <br><br>
