      ...
      <div class="ui-onboard__wr-in">
        <div class="ui-onboard__wr-in-main">
          <div class="ui-onboard__wr-in-main--top">
            <a href="<?php echo url('/'); ?>">
              <img src="<?php echo url('assets/frontend/img/logo.png'); ?>" alt="logo" class="top-logo">
            </a>
            <h2 class="onboard-navbar-text"><?php echo setting('app.title'); ?></h2>
          </div>
                ...
                <form action="" method="post" name="register">
                     <div class="form-row">
                      ...
                      <div class="row add_new mt-4">
                        <label for="law_firm">Practice Area(s)</label>
